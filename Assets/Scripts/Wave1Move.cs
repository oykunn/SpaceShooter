...
public class Wave1Move : MonoBehaviour {
	...
	IEnumerator Start () {
		...
		while (true){
			...
			yield return StartCoroutine (MoveObject (transform, point5, point6, 3.0f));
			yield return StartCoroutine (MoveObject (transform, point6, point7, 3.0f));
			yield return StartCoroutine (MoveObject (transform, point7, point8, 3.0f));
			yield return StartCoroutine (MoveObject (transform, point8, point9, 3.0f));
